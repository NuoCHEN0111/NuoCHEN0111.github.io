...
**Towards buried object localisation in landslide using UHF RFID: insights from lab- and field-scale experiments**, **Nuo Chen**, Jun Fang, Minghe Wang, Clarence E. Choi\*, <span class="badge2">Géotechnique</span> (Under review)

**A new slope failure detection method based on the slope surface tilting measurement using MEMS**, Jiren Xie, Jiaxun Chen, Yue Lu, Jian Liu, Huihua Hu, **Nuo Chen**, Taro Uchimura, Siyuan Zhao\*, Wenli Lin\*, <span class="badge2">Transportation Geotechnics</span> (Major revise)
